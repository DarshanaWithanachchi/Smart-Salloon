          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="User Name" name="uname">
                </div>  
                <div class="form-group">
                  <label >Gender</label>
                   <div class="radio">
                ...
                <div class="form-group">
                  ...
                  <input type="text_area" class="form-control" id="exampleInputPassword1" placeholder="Address 01" name="address1">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Phone Number" name="pnumber">
                </div>
