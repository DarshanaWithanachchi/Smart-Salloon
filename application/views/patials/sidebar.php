      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="<?php echo base_url().'#'; ?>">
            <i class="fa fa-dashboard"></i> <span>Add</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'index.php/Home/AddReception' ?>"><i class="fa fa-circle-o"></i> Reception</a></li>
            <li><a href="<?php echo base_url().'index.php/Home/AddCustomer'; ?>"><i class="fa fa-circle-o"></i> Customers</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'index.php/Home/AddHairStyleMale'; ?>"><i class="fa fa-circle-o"></i> Male</a></li>
            <li><a href="<?php echo base_url().'#'; ?>"><i class="fa fa-circle-o"></i> Female</a></li>
          </ul>
        </li>
            <li><a href="<?php echo base_url().'#'; ?>"><i class="fa fa-circle-o"></i> Nail Styles</a></li>
            <li><a href="<?php echo base_url().'#'; ?>"><i class="fa fa-circle-o"></i> Wedding </a></li>
            <li><a href="<?php echo base_url().'#'; ?>"><i class="fa fa-circle-o"></i> Others</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="<?php echo base_url().'#'; ?>">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url().'index.php/Home/Register'; ?>"><i class="fa fa-circle-o"></i> Register</a></li>
