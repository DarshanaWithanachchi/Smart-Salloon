          ...
          <div class="box box-primary">
            ...
            <div class="box-body">                
                ...
                <div class="form-group">
                  ...
                  <input type="text_area" class="form-control" id="exampleInputPassword1" placeholder="Address 01">
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Address 02">
                  <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Address 03">
                </div>
                <div class="form-group">
